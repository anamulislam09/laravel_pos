                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    @php
                      ...
                      $user = App\Models\User::where('customer_id', Auth::guard('admin')->user()->id)->exists();
                    @endphp
                        ...
                        <tbody>
                          <form action="{{ route('users.store') }}" method="POST">
                            ...
                            @foreach ($data as $key => $item)
                              @php
                                $flat = App\Models\Flat::where('customer_id', Auth::guard('admin')->user()->id)
                              ...
                              <tr>
                                ...
                                <td>{{ $key + 1 }}</td>
                                {{-- <td><input type="text" name="flat_name[]" style="width: 50px; border:none"
                                    value="{{ $flat->flat_name }}"></td> --}}
                                    {{-- {{$flat('flat_name')}} --}}

                                <td><input type="text" name="name[]" style="width: 140px; border:none"
                                    placeholder="User name">
                                </td>
                                <td><input type="text" name="phone[]" style="width: 140px ; border:none"
                                    placeholder="User phone">
                                </td>
                                <td><input type="text" name="nid_no[]" style="width: 140px ; border:none"
                                    placeholder="User NID No">
                                </td>
                                <td>
                                  <textarea name="address[]" class="" style="width: 140px ; border:none" id="" cols=""
                                    rows="1" placeholder="User Address"></textarea>
                                </td>
                                <td><input type="email" name="email[]" style="width: 140px ; border:none"
