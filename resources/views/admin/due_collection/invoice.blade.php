    ...
    <div class="container">
        ...
        <div class="bodyInfo">
            ...
            <div class="right-text">
                <p style="margin-top: 0px">{!! DNS1D::getBarcodeHTML("$inv->invoice_id", 'C128', 1.0, 30) !!}</p>
                <p>Date :{{ date('m/d/y') }}</p>
            </div>
        </div>
        @php
        ...
        @php
            ...
            $user = App\Models\User::where('customer_id', $inv->customer_id)
        ...
        <div class="body">
            <p>Received with thanks from mr./ms <strong><span style="border-bottom: 2px dotted #000; padding:0px 70px">
                        {{ $user->name }}</span></strong> The sum of tk. (in words)<strong><span
                ...
                Month of <strong><span style="border-bottom: 2px dotted #000; padding:0px 70px">
                        ...
                        {{ $inv->amount }}</span></strong>. </p>

        </div>
        <div class="footer">
            <div class="Prepared">
                <p style=" margin-bottom:-15px; text-align:center; width:40%">{{ $customer->name }}</p>
                <h4>Prepared by</h4>
            </div>
            <div class="Recipient">
                <p></p>
